...
<template>
  <div class="flex flex-col relative">
    <label class="container">
      <div class="simple-text font-800!">Click me!</div>
      <input
        v-model="checked"
        type="checkbox" />
    ...
    <span class="text-3 text-#000">From Uiverse.io by KSAplay</span>
  </div>
</template>
...
.container input:checked ~ .torch .face {
  filter: drop-shadow(0px 0px 2px rgb(255, 255, 255)) drop-shadow(0px 0px 10px rgba(255, 237, 156, 0.7))
